...
const ProjectDetail = () => {
    ...
    const thumbnailImage = project.images?.find(img => img.isThumbnail)?.url || project.images?.[0]?.url;
    const displayScreenshots = project.screenshots?.length > 0 ? project.screenshots :
